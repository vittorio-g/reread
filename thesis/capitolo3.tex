% =====================================================================
% Thesis — Chapter 3
% ReReReRe: A Permutation-Based Coherence Detector
...
\title{ReReReRe: A Permutation-Based Coherence Detector}
\shorttitle{ReReReRe}
\author{Vittorio Guerrieri}
\affiliation{Chapter~3 of the thesis}
...
(Section~2.4). A careless respondent's answers to the same pair are
...
constructs this baseline by permutation (Section~2.6). For each of
...
\label{eq:zrr}
\end{equation}
This is the permutation z-score of Equation~2.3, specialized to coherence.
...
This choice is principled. Section~2.2 noted that the Pearson correlation is
...
ReReReRe estimates the number of factors by parallel analysis (Section~2.4),
...
(Section~2.10). Here ReReReRe's AUC, computed with fully fixed defaults, climbs
...
intervals introduced in Section~2.7, exactly how much the coherence signal
contributes.
