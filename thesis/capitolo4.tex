% =====================================================================
% Thesis — Chapter 4
% An Ensemble Detector: Combining ReReReRe with Auxiliary Indices
...
\title{An Ensemble Detector}
\shorttitle{An Ensemble Detector}
\author{Vittorio Guerrieri}
\affiliation{Chapter~4 of the thesis}
...
The five features are combined by a Random Forest (Section~2.8): an ensemble of
...
(Section~2.9): each respondent receives an out-of-fold predicted probability
...
respondent indices (500 resamples; Section~2.7) and recomputed
