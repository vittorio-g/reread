% =====================================================================
% Thesis — Chapter 1
% Careless Responding Detection: The Field, Current Practices, and Software
% Class: apa7 (doc option) + biblatex-apa (APA 7th)
% Compile: biber (pdflatex -> biber -> pdflatex -> pdflatex)
% =====================================================================
...
% --- helper column types for the summary table ---
\newcolumntype{L}[1]{>{\RaggedRight\arraybackslash}p{#1}}

% apa7 loads hyperref; hide the colored link borders for a clean print look
\hypersetup{hidelinks}

\title{Careless Responding Detection: The Field, Current Practices, and Software}
\shorttitle{Careless Responding Detection}
\author{Vittorio Guerrieri}
\affiliation{Chapter~1 of the thesis}
